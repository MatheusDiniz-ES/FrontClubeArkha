      ...
      cell: ({ row }) => (
        <Popover.Root>
          ...
          <Popover.Portal>
            ...
            >
              <Link
                href={`/backoffice/usuarios/${row.original.id}`}
                className={clsx(
                ...
                <div
                  ...
                  onClick={() =>
                    showDialog({
                          ...
                          subtitle:
                            row.original.status == 'Ativo'
                              ? "Ao confirmar a inativação, este usuário terá suas permissões inativadas até sua reativação."
                              : "Ao confirmar a ativação, este usuário terá suas permissões ativadas.",
                          secondButton: {
                            children: "Cancelar",
